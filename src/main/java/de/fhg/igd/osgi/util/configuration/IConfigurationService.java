...
/**
 * <p>Title: IConfigurationService</p>
 * <p>Description: An interface for a configuration service in an OSGI environment</p>
...
public interface IConfigurationService {
	 ...
	 * @param key the key
	 * @return the value or null if the configuration item has not
	 * been set yet
	 */
	 ...
	 * 
	 * @param key the key
	 * @param defaultValue the custom default value
	 *  
	 * @return the value or the default value if the
	 * configuration item has not been set yet
	 */
	 ...
	 * @param key the key
	 * @return the value as an integer or null if the configuration item
	 * has not been set
	 * @throws NumberFormatException if the saved configuration item cannot
	 ...
	 * @param key the item's key
	 * @param value the item's value as an integer
	 */
	 ...
	 * @param key the item's key
	 * @param value the item's value as a boolean
	 */
